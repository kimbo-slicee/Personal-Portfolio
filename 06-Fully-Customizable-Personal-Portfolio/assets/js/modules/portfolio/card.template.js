...
<div class="features">
            <h4 class="project-title">Features</h4>
            <ol class="features--list" role="list">
                ${
                features?.map(f=>`<li class="features--item" >
                ${f}</li>`).join('')
                }
            </ol>
    </div>
...
const renderBack = ({images:{gallery},
  ...
  <div class="back-overlay">
      <div class="close-btn-container">${renderCloseButton()}</div>
